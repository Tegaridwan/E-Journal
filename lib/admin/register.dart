...
class _RegisterState extends State<Register> {
  ...
  // Fungsi untuk mendaftar pengguna baru dan menyimpan data ke Firebase Firestore
  ...
  Future<void> postDetailsToFirestore(User user, String email, String rool) async {
    try {
      ...
      await firebaseFirestore.collection('users').doc(user.uid).collection('journals').add({
      ...
      await firebaseFirestore.collection('users').doc(user.uid).collection('izin').add({
        'first_entry': 'Welcome to your journal!',
        'timestamp': DateTime.now(),
        'date': '',
        'alasan': '',
